...
![CSR 렌더링 프로세스](https://images.prismic.io/prismic-main/ZjhPlEMTzAJOCi_n_CSR.png?auto=format%2Ccompress&fit=max&w=3840)
...
![SSR 렌더링 프로세스](https://images.prismic.io/prismic-main/ZjhQ5EMTzAJOCi_3_SSR.jpeg?auto=format%2Ccompress&fit=max&w=3840)
...
![FCP](https://web.dev/static/articles/fcp/image/fcp-timeline-googlecom_1920.png?hl=ko)
